                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4 col-sm-4 col-xs-12">
                                    ...
                                    <select name="sub_category_id" id="sub_category_id" class="form-control">
                                        ...
                                        @if($product->sub_category_id == $scat->id)
                                ...
                                <div class="form-group col-md-4 col-sm-6 col-xs-12">
                                    ...
                                    <div class="input-group mb-3">
                                        <div class="custom-file">
                                            <input type="file" id="image_url" class="custom-file-input" name="image_url" accept=".png, .jpg, .jpeg" value="{{ $product->image }}"> <label class="custom-file-label" for="inputGroupFile01">Choose file</label>
                                        </div>
                                    </div>
                                    @error('image_url')
                                    <span class="invalid-feedback" role="alert">
                                    ...
                                    @enderror
                                    <img src="{{ asset('images/products/'.$product->image) }}" id="image" class="w-25 mt-2" />
                                </div>
                                <div class="form-group col-md-12 col-sm-6">
                                    <label>Descriptions <span class="required-star">*</span></label>
                                    <textarea name="description" id="description" cols="15" rows="2" class="form-control text-area">{{$product->description}}</textarea>
                                </div>
...
<script>
    ...
    //subcategory on change categories

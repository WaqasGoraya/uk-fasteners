                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="form-group col-md-4 col-sm-6 col-xs-12">
                                    ...
                                    <input type="text" maxlength="50" class="form-control @error('name') is-invalid @enderror" name="name" value="{{old('name')}}" placeholder="Enter Product Name" required>
                                    @error('name')
                                ...
                                <div class="form-group col-md-4 col-sm-6 col-xs-12">
                                    ...
                                    <div class="input-group mb-3">
                                        <div class="custom-file">
                                            <input type="file" id="image_url" class="custom-file-input @error('image_url') is-invalid @enderror " name="image_url" accept=".png, .jpg, .jpeg" required>
                                ...
                                <div class="form-group col-md-12 col-sm-6">
                                    ...
                                    <textarea name="description" id="description" cols="15" rows="2" class="form-control text-area"></textarea>
                                </div>
                            </div>
                        </div>
                        <!-- /.card-body -->
